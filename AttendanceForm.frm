...
Begin VB.Form AttendanceForm 
   ...
   Begin VB.ComboBox Combo3 
      Height          =   360
      ItemData        =   "AttendanceForm.frx":0000
      Left            =   12000
      List            =   "AttendanceForm.frx":0016
      TabIndex        =   8
      Top             =   1200
      Width           =   1335
   End
...
tRS.Open "select SubjectName from SubjectTab where coursename='" & Combo1 & "' order by subjectName", Conn
...
MSF.TextMatrix(0, 3) = "Total"
MSF.TextMatrix(0, 4) = "Attended"
...
'EmpListReport.Show
Conn.Execute "delete from AttendanceTab where coursename='" & Combo1 & "' and subjectname='" & Combo2 & "'"

For I = 1 To MSF.Rows - 1
If Not MSF.TextMatrix(I, 0) = "" Then
Conn.Execute "insert into AttendanceTab values(" & Val(MSF.TextMatrix(I, 0)) & ",'" & MSF.TextMatrix(I, 1) & "','" & MSF.TextMatrix(I, 2) & "','" & Combo1 & "','" & Combo3 & "','" & Combo2 & "'," & Val(MSF.TextMatrix(I, 3)) & "," & Val(MSF.TextMatrix(I, 4)) & ")"
End If
Next
