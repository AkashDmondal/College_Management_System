...
Begin VB.Form AttendanceViewForm 
   BackColor       =   &H00C0E0FF&
   ...
   Begin VB.ComboBox Combo3 
      Height          =   360
      ItemData        =   "AttendanceViewForm.frx":0000
      Left            =   12000
      List            =   "AttendanceViewForm.frx":0016
      TabIndex        =   5
      Top             =   1200
      Width           =   1335
   End
   ...
   End
End
Attribute VB_Name = "AttendanceViewForm"
...
If tRS.State = 1 Then tRS.Close
tRS.Open "select RegNo,sName,subjectName,tClass,aClass from AttendanceTab  where coursename='" & Combo1 & "' and semister='" & Combo3 & "'  order by regNo,subjectName", Conn
