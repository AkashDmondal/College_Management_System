...
Begin VB.Form QualificationForm 
   BackColor       =   &H00FFFFC0&
   ...
   End
End
Attribute VB_Name = "QualificationForm"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Dim QualificationNameVar As String
...
Conn.Execute "delete from QualificationTab where QualificationName ='" & QualificationNameVar & "'"
...
MSF.Clear
MSF.Cols = 2
MSF.TextMatrix(0, 0) = "Qualification"
...
tRS.Open "select * from QualificationTab  order by QualificationName", Conn
...
Conn.Execute "delete from QualificationTab where QualificationName ='" & QualificationNameVar & "'"
Conn.Execute "insert into QualificationTab values('" & Text1 & "','" & Text2 & "')"
butSave.Enabled = False
ButNew.Enabled = True
butModify.Enabled = False
butDelete.Enabled = False
...
End If
If tRS.State = 1 Then tRS.Close
tRS.Open "select * from QualificationTab where QualificationName='" & Text1.Text & "'", Conn
If tRS.EOF = False Then
MsgBox ("This Qualification is allready present,Please check")
Exit Sub
End If
...
QualificationNameVar = MSF.TextMatrix(MSF.Row, 0)

If tRS.State = 1 Then tRS.Close
tRS.Open "select * from QualificationTab where QualificationName ='" & QualificationNameVar & "'", Conn
If tRS.EOF = False Then
Text1 = tRS(0)
Text2 = tRS(1)
