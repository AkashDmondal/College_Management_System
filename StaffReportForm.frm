...
Begin VB.Form StaffReportForm 
   BackColor       =   &H00C0E0FF&
   Caption         =   "Staff List Report Form"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "StaffReportForm"
...
MSF.Rows = 5
tAmt = 0
MSF.TextMatrix(0, 0) = "Code"
MSF.TextMatrix(0, 1) = "Name"
MSF.TextMatrix(0, 2) = "Address"
MSF.TextMatrix(0, 3) = "Mobile"
MSF.TextMatrix(0, 4) = "Subject"
