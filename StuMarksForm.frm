...
Begin VB.Form StuMarksForm 
   ...
   End
End
Attribute VB_Name = "StuMarksForm"
...
If tRS.State = 1 Then tRS.Close
tRS.Open "select subjectName,pMarks,tMarks from MarksTab where regno='" & RegVar & "' and semister='" & MSF.TextMatrix(3, 1) & "' order by subjectName", Conn
